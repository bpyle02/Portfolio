        ...
        <div className = "mx-auto py-12">
            ...
            <div className = "flex flex-wrap m-8">
                <div className = "p-4 sm:w-1/2 lg:w-1/3">
                    <div className = "h-full rounded-xl overflow-hidden shadow-2xl dark:shadow-gray-100/20 dark:bg-gray-900">
                        ...
                        <div className = "p-6 dark:text-gray-100">
                            ...
                            <div className = "flex align-center justify-center font-semibold dark:text-gray-100">
                                <a href = "https://github.com/bpyle02/portfolio" className = "inline-flex items-center md:mb-2 lg:mb-0 px-3 py-2 mr-3 hover:bg-gray-200 dark:hover:bg-gray-800 duration-300 transition-colors rounded">Code</a>
                                <a href = "https://bpyle02.github.io/portfolio/" className = "inline-flex items-center md:mb-2 lg:mb-0 px-3 py-2 mr-3 hover:bg-gray-200 dark:hover:bg-gray-800 duration-300 transition-colors rounded">Live Demo</a>
                            </div>
                        </div>
                    </div>            
                </div>
                <div className = "p-4 sm:w-1/2 lg:w-1/3">
                    <div className = "h-full rounded-xl overflow-hidden shadow-2xl dark:shadow-gray-100/20 dark:bg-gray-900">
                        ...
                        <div className = "p-6 dark:text-gray-100">
                            ...
                            <div className = "flex align-center justify-center font-semibold dark:text-gray-100">
                                <a href = "https://hackaday.io/project/179756-handheld-raspberry-pi-retro-game-console" className = "inline-flex items-center md:mb-2 lg:mb-0 px-3 py-2 mr-3 hover:bg-gray-200 dark:hover:bg-gray-800 duration-300 transition-colors rounded">Code</a>
                                <a href = "https://youtu.be/3kafVUv4qtQ" className = "inline-flex items-center md:mb-2 lg:mb-0 px-3 py-2 mr-3 hover:bg-gray-200 dark:hover:bg-gray-800 duration-300 transition-colors rounded">Live Demo</a>
                            </div>
                        </div>
                    </div>            
                </div>
                <div className = "p-4 sm:w-1/2 lg:w-1/3">
                    <div className = "h-full rounded-xl overflow-hidden shadow-2xl dark:shadow-gray-100/20 dark:bg-gray-900">
                        ...
                        <div className = "p-6 dark:text-gray-100">
                            ...
                            <div className = "flex align-center justify-center font-semibold dark:text-gray-100">
                                <a href = "https://hackaday.io/project/179756-handheld-raspberry-pi-retro-game-console" className = "inline-flex items-center md:mb-2 lg:mb-0 px-3 py-2 mr-3 hover:bg-gray-200 dark:hover:bg-gray-800 duration-300 transition-colors rounded">Code</a>
                                <a href = "https://hackaday.io/project/179756-handheld-raspberry-pi-retro-game-console" className = "inline-flex items-center md:mb-2 lg:mb-0 px-3 py-2 ml-3 hover:bg-gray-200 dark:hover:bg-gray-800 duration-300 transition-colors rounded">Live Demo</a>
                            </div>
                        </div>
                    </div>            
                </div>            
